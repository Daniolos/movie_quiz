...
class TestMovieQuiz(unittest.TestCase):
    ...
    @patch("movie_quiz.ID_BY_MOVIE", "")
    @patch("movie_quiz.STARTING_TEXT", "")
    @patch("movie_quiz.show_movie_title")
    @patch("time.sleep")
    @patch("movie_quiz.input")
    @patch("movie_quiz.show_movie_description")
    @patch("movie_quiz.run_keyword_quiz")
    @patch("movie_quiz.set_movie", return_value=get_movie_mock())
    @patch("movie_quiz.get_status_code_info")
    @patch("movie_quiz.get_response_by_movie_id", return_value=ResponceMock(200))
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
        get_status_code_info_mock: MagicMock,
        set_movie_mock: MagicMock,
        run_keyword_quiz_mock: MagicMock,
        show_movie_description_mock: MagicMock,
        input_mock: MagicMock,
        sleep_mock: MagicMock,
        show_movie_title_mock: MagicMock,
    ):
        mq.main()

        self.assertEqual(print_mock.call_count, 2)
        get_random_movie_id_mock.assert_called_once()
        get_response_by_movie_id_mock.assert_called_once()
        get_status_code_info_mock.assert_not_called()
        set_movie_mock.assert_called_once()
        run_keyword_quiz_mock.assert_called_once()
        show_movie_description_mock.assert_called_once()
        input_mock.assert_called_once()
        sleep_mock.assert_not_called()
        show_movie_title_mock.assert_called_once()
    ...
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main_skippable_set_to_false(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
    ...
    @patch("movie_quiz.set_movie", return_value=get_movie_mock())
    @patch("movie_quiz.get_status_code_info")
    @patch("movie_quiz.get_response_by_movie_id", return_value=ResponceMock(438))
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main_problematic_status_code(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
        ...
        get_random_movie_id_mock.assert_called_once()
        get_response_by_movie_id_mock.assert_called_once()
        get_status_code_info_mock.assert_called_once()
        set_movie_mock.assert_not_called()
        run_keyword_quiz_mock.assert_not_called()
        show_movie_description_mock.assert_not_called()
        input_mock.assert_not_called()
        sleep_mock.assert_not_called()
        show_movie_title_mock.assert_not_called()
    ...
    @patch("movie_quiz.show_movie_description")
    @patch("movie_quiz.run_keyword_quiz")
    @patch("movie_quiz.set_movie", return_value=get_movie_mock(k=False))
    @patch("movie_quiz.get_status_code_info")
    @patch("movie_quiz.get_response_by_movie_id", return_value=ResponceMock(200))
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main_no_keywords(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
    ...
    @patch("movie_quiz.show_movie_description")
    @patch("movie_quiz.run_keyword_quiz")
    @patch("movie_quiz.set_movie", return_value=get_movie_mock(d=False))
    @patch("movie_quiz.get_status_code_info")
    @patch("movie_quiz.get_response_by_movie_id", return_value=ResponceMock(200))
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main_no_description(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
    ...
    @patch("movie_quiz.show_movie_description")
    @patch("movie_quiz.run_keyword_quiz")
    @patch("movie_quiz.set_movie", return_value=get_movie_mock(t=False))
    @patch("movie_quiz.get_status_code_info")
    @patch("movie_quiz.get_response_by_movie_id", return_value=ResponceMock(200))
    @patch("movie_quiz.get_random_movie_id")
    @patch("movie_quiz.print")
    def test_main_no_title(
        self,
        print_mock: MagicMock,
        get_random_movie_id_mock: MagicMock,
        get_response_by_movie_id_mock: MagicMock,
